...
print("Number of past winning euromillions combinations : ",
      winning_numbers_len)
print("Statistical properties of winning resuslts data")
print(winning_numbers.describe())

print(
    "Number of random generated euromillions combinations : ", randomdata_len)
...
heatmap = plt.pcolor(np.reshape(np.array(freqs), (5, 5)), cmap=plt.cm.Blues)
plt.show()
